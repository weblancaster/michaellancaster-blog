...
posts: "/posts/2013-09-09-how-i-built-lollagram-lollapalooza-instagram-real-time-api/"
description: A month ago was the event Lollapalooza in Chicago and some co-workers from my former company had an idea two years ago (if I'm not wrong) to develop a web Application showing latest pictures people were sharing from the event..and this year I wanted to take it to the next level.
---
